...
const Register = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (firstnam!==""&&lastName!==""&&email!=="") {
          axios.post("https://relianceapi.onrender.com/signup").then((e) => {
  ...
  return (
    <div style={{height:"700px"}}>
        <br/>
        <Box onSubmit={handleSubmit} margin="auto" width="500px" boxShadow='md' display="flex" flexDirection="column" height="600px" justifyContent="space-around" alignItems="center">
        ...
        {first?<Button colorScheme='red' variant='outline' onClick={handleEmail} required>
            Verify Email
        </Button>:<Flex>
